<template>
  <div class="container">
    ...
    <div class="create-post">
      ...
      <input type="text" id="create-post" v-model="text" v-on:keyup.enter="createPost" placeholeder="Create a post">
    ...
    <div class="post-container">
      ...
      <button class="post-button" v-on:click="deletePost(post._id)">X</button>
      </div>
    </div>
